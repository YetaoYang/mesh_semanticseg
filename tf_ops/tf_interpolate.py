...
def interpolate_label_with_color(sparse_points, sparse_labels, dense_points, knn, radius):
    """
    Input:
        ...
        radius: float, use radius for label interpolation
    Output:
    ...
    return interpolate_module.interpolate_label_with_color(
        sparse_points, sparse_labels, dense_points, knn, radius
    )
